...
public class DriverInstance{
	...
	public void setDriver(String browser, boolean headless) throws MalformedURLException {		
		...
		case "chrome":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://4.240.111.124:32000/wd/hub"), options));
			break;
		case "firefox":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://4.240.111.124:32000/wd/hub"), firefoxOptions));
			break;
		case "edge":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://4.240.111.124:32000/wd/hub"), edgeOptions));
			break;	
		case "ie":
